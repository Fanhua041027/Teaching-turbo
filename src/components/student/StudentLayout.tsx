...
const menuItems = [
  { name: "代码沙箱", path: "/student/sandbox", icon: "fa-code" },
  { name: "学习笔记", path: "/student/notes", icon: "fa-note-sticky" },
  { name: "学习路径", path: "/student/path", icon: "fa-map" },
  { name: "作业中心", path: "/student/assignments", icon: "fa-file-pen" },
  { name: "AI学习助手", path: "/student/ai-assistant", icon: "fa-robot" },
  { name: "教学资源", path: "/student/resources", icon: "fa-book" },
];
    ...
    <div className="flex h-screen bg-gray-50 text-gray-800">
      ...
      >
        <div className="p-4 flex items-center justify-between border-b border-[#3E92CC]/30">
          {!collapsed && <h1 className="text-xl font-bold">学生门户</h1>}
          <button
